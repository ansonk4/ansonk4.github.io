...
export default function Home() {
  ...
  return (
    <div
      ref={rootRef}
      className={`relative h-screen min-h-[600px] w-screen overflow-hidden border border-black max-[600px]:h-[100svh] max-[600px]:min-h-0 ${
            ...
            <div className="bento-cell flex flex-col bento-safe-center">
              <div className="flex w-full flex-row-reverse items-center justify-end gap-6">
                <Image
                  ...
                  height={180}
                  priority
                  className="h-[180px] w-[140px] shrink-0 rounded-lg object-cover max-[600px]:h-[155px] max-[600px]:w-[120px]"
                />
